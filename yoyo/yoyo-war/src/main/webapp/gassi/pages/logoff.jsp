...
<body>
  <div class="site">
    ...
    <div class="contentContainer">
      ...
      <div class="content">
        <!--  form main title -->
        <h2>Thank you for using prototypes</h2>
        
        <div class="center">
          <a href="../.." class="arrow" title="reconnect">Reconnect</a>
        </div>
      <!-- END CONTENT -->
      </div>
...
<%
// session is invalidated here and in application
session.invalidate(); %>
