...
/**
 * Drives {@link HomeASideBarView}. An activity in GWT 2.1 is analogous to a
 ...
 */
public class HomeASideBarPresenterImpl extends AbstractActivity {

	// managed view
	private final HomeASideBarView view;

	public HomeASideBarPresenterImpl(HomeASideBarView view) {
		super();
		this.view = view;
	}
