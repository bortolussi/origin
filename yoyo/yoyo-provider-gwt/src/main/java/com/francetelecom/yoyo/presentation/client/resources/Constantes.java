 ...
 * 	'E:/development/origin/yoyo/yoyo-provider-gwt/src/main/java/com/francetelecom/yoyo/presentation/client/resources/Constantes.properties'.
 */
public interface Constantes extends com.google.gwt.i18n.client.Constants {
  ...
  /**
   * Translated "Vous allez annuler vos modifications, désirez-vous continuer ?".
   * 
   * @return translated "Vous allez annuler vos modifications, désirez-vous continuer ?"
   */
   ...
   * 
   * @return translated "Ce marché a été supprimé par un autre utilisateur"
   */
   ...
   * 
   * @return translated "Votre session est expirée, veuillez vous reconnecter"
   */
  ...
  /**
   * Translated "Cette application a été créée à partir de l'archetype <b>orange-archetype-GWT-jpa</b>. Elle peut servir de point de départ à tout projet mettant en oeuvre les technologies préconisées suivantes&nbsp;:<ul><li>Maven</li><li>Hibernate JPA</li><li>Spring</li><li>GWT</li></ul><br/>L'onglet marché propose un exemple de gestion d'une entité (méthodes CRUD), à l'aide de fonctions simples ou avancées de GWT.".
   * 
   * @return translated "Cette application a été créée à partir de l'archetype <b>orange-archetype-GWT-jpa</b>. Elle peut servir de point de départ à tout projet mettant en oeuvre les technologies préconisées suivantes&nbsp;:<ul><li>Maven</li><li>Hibernate JPA</li><li>Spring</li><li>GWT</li></ul><br/>L'onglet marché propose un exemple de gestion d'une entité (méthodes CRUD), à l'aide de fonctions simples ou avancées de GWT."
   */
  ...
  /**
   * Translated "présentation - Modification feature 01".
   * 
   * @return translated "présentation - Modification feature 01"
   */
  @DefaultStringValue("présentation - Modification feature 01")
  @Key("homePage.title")
   ...
   * 
   * @return translated "Vous allez quitter l'application, désirez-vous continuer ?"
   */
  ...
  /**
   * Translated "le champ 'nom du marché' est obligatoire (doit contenir au minimum 5 caractères)".
   * 
   * @return translated "le champ 'nom du marché' est obligatoire (doit contenir au minimum 5 caractères)"
   */
   ...
   * 
   * @return translated "Aucune information ne correspond aux critères spécifiés"
   */
